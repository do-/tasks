...
_.get_vocs = (done) => {
    ...
    var data = {"users":[{"label":"Овсянко Дмитрий","id":1,"fake":0},{"label":"Потапов Виталий","fake":0,"id":2}]}
