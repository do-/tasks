    ...
    return function (data, view) {
        ...
        $('main').w2regrid ({ 
            ...
            columns: [
                ...
                {field: 'task_note.label',        caption: 'Текст',   size: 100},
                {field: 'task_note.id_user_from', caption: 'Автор',   size: 30, voc: data.users},
                {field: '_',                      caption: ' ',       size: 5, render: function () {return '&rarr;'}},
                {field: 'task_note.id_user_to',   caption: 'Адресат', size: 30, voc: data.users},
